...
def test_calculator_add(page, fastapi_server):
    ...
    # Wait for the UI to update after the async API call, then assert the rendered result.
...
def test_calculator_divide_by_zero(page, fastapi_server):
    ...
    # Wait for the UI to update after the async API call, then assert the error message.
